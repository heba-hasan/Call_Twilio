 ...
 * @author heba
 */
public class Showcalllogs extends HttpServlet {
...
"                    <td class=\"list top\">Call Duration</td>\n" +
...
while (res.next()) {
    pen.println("<tr class=\"list\">\n" +
                 "    <td class=\"list id\">" + res.getString("call_id") + "</td>\n" +
                 "    <td class=\"list\">" + res.getString("sender_number") + "</td>\n" +
                 "    <td class=\"list\">" + res.getString("reciever_number") + "</td>\n" +
                 "    <td class=\"list\">" + res.getString("call_duration") + "</td>\n" +
 "    <td class=\"list\">" + res.getString("call_time") + "</td>\n" +
 "    <td class=\"list status\">" + res.getString("call_status")
         +
 "</tr>\n");
}
